...
public final class NoBukkit {
    ...
    /**
     * 创建包含 Core 通用绑定和指定 Bukkit 版本扩展的 JavaTypes。
     *
     * @param plugin 业务插件
     * @param module 当前运行的版本模块
     * @return 完整 JavaTypes
     */
    ...
    static void register(JavaTypes.Builder builder, Plugin plugin) {
        ...
        JavaTypeRef eventClassType = JavaTypeRef.parameterized(
                "Class", Class.class, JavaTypeRef.javaType(Event.class));
        builder.globalObject("NoBukkit", object -> object
                        ...
                        .object("event", event -> event
                                ...
                                .function("listen", function -> function
                                        .param("eventType", eventClassType)
    ...
    public static final class EventApi {
         ...
         * 注册 Bukkit 事件监听器。
         */
        public EventRegistration listen(Class<? extends Event> eventType,
                                         EventPriority priority,
                                         boolean ignoreCancelled,
                                         BukkitEventListener listener) {
            return registrar.listen(eventType, priority, ignoreCancelled, listener);
        }
    }
}
