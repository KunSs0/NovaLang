package com.novalang.bukkit.paper.entity;
...
/** Paper 版本实体扩展的反射辅助。 */
public final class PaperEntityReflection {

    private PaperEntityReflection() {
    }
    ...
    /** 将 Paper 枚举公开为 Nova 全局查询函数。 */
    @SuppressWarnings({"rawtypes", "unchecked"})
    public static void registerEnum(JavaTypes.Builder builder, String functionName, Class<?> enumType) {
        builder.globalFunction(functionName, function -> function.param("name", String.class).returns(JavaTypeRef.javaType(enumType).nullable()).invoke(arguments -> enumValue(enumType, (String) arguments[0])));
    }
