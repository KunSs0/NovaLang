...
public final class NovaAbstractWindCharge {
    ...
    public static void register(JavaTypes.Builder builder) {
        Class<?> type = PaperEntityReflection.type(NovaAbstractWindCharge.class, TYPE);
        Method explode = PaperEntityReflection.method(type, "explode");
        builder.extension(type, "explode", function -> function.returns(Void.TYPE).invoke(arguments -> PaperEntityReflection.invoke(explode, arguments[0])));
    }
}
