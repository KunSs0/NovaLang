...
public final class NovaWorldInventoryEnum {
    ...
    public static void register(JavaTypes.Builder builder) {
        Bukkit112EnumSupport.registerEnum(builder, "patternType", PatternType.class);
        Bukkit112EnumSupport.registerEnum(builder, "mirror", Mirror.class);
        Bukkit112EnumSupport.registerEnum(builder, "structureRotation", StructureRotation.class);
        Bukkit112EnumSupport.registerEnum(builder, "usageMode", UsageMode.class);
    }
}
