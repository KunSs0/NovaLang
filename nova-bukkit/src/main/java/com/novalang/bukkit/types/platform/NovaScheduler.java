...
final class NovaScheduler {
    ...
    static void register(JavaTypes.Builder builder) {
        ...
        builder.extension(BukkitScheduler.class, "scheduleSyncDelayedTask", f -> f.param("plugin", Plugin.class).param("task", BukkitRunnable.class).param("delay", Long.class).returns(Integer.class).invoke(a -> NovaTypeSupport.argument(a, 0, BukkitScheduler.class).scheduleSyncDelayedTask(NovaTypeSupport.argument(a, 1, Plugin.class), NovaTypeSupport.argument(a, 2, BukkitRunnable.class), NovaTypeSupport.argument(a, 3, Long.class))));
        ...
        builder.extension(BukkitScheduler.class, "scheduleSyncDelayedTask", f -> f.param("plugin", Plugin.class).param("task", BukkitRunnable.class).returns(Integer.class).invoke(a -> NovaTypeSupport.argument(a, 0, BukkitScheduler.class).scheduleSyncDelayedTask(NovaTypeSupport.argument(a, 1, Plugin.class), NovaTypeSupport.argument(a, 2, BukkitRunnable.class))));
        ...
        builder.extension(BukkitScheduler.class, "scheduleSyncRepeatingTask", f -> f.param("plugin", Plugin.class).param("task", BukkitRunnable.class).param("delay", Long.class).param("period", Long.class).returns(Integer.class).invoke(a -> NovaTypeSupport.argument(a, 0, BukkitScheduler.class).scheduleSyncRepeatingTask(NovaTypeSupport.argument(a, 1, Plugin.class), NovaTypeSupport.argument(a, 2, BukkitRunnable.class), NovaTypeSupport.argument(a, 3, Long.class), NovaTypeSupport.argument(a, 4, Long.class))));
