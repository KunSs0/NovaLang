...
public final class NovaChunkSnapshot {
    ...
    public static void register(JavaTypes.Builder builder) {
        ...
        builder.extension(ChunkSnapshot.class, "getData", f -> f.param("x", Integer.class).param("y", Integer.class).param("z", Integer.class).returns(Integer.class).invoke(a -> snap(a).getData(arg(a, 1, Integer.class), arg(a, 2, Integer.class), arg(a, 3, Integer.class))));
